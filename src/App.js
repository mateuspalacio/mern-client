 ...
 <div className="row">
  <form className="col s12" onSubmit={onSubmitHandler}>
    ...
    <div className="row right-align">
      <button className="button.wave-effect.waves-light btn">Submit</button>
    </div>
  </form>
{
...
<ul className="collection">
 ...
 <p>{todo.content}
 <a href="#!" onClick={() => removeTodo(todo._id)} className="secondary-content"><i className="material-icons">delete</i></a></p></div></li>
   ) )      
}
